...
- we all know that teachers can draw on different information sources e.g., anecdotal evidence such as advises from colleagues or scientific evidence - findings from a reasearch study - when it comes to professional actions
- Considering scientific evidence in school practice is increasingly valued by policy makers and scientists because it is regarded as best available knowledge and a more objective information source
- Considering Scientific evidence can help to e.g., develop new practices or solve problems that have repeatedly emerge -> known as evidence-informed practice
...
- hence, they often evaluate whether the information appears trustworthy
...
- if teachers evaluate the extent to which an information, e.g., scientific evidence, appears trustworthy, we conduct what is known as second-hand evaluation
...
- beliefs about the trustworthiness of different sources of evidence can influence the trustworthiness
...
- In addition to different trust in different sources, teachers prior beliefs about specific educational topics might also influence teachers' trust rating
- onw way of influence can be: confirmation bias means that one's own prior beliefs influence the search for and interpretation of information
  - in the sense that 
...
- in other words confirmation bias might be problematic because it can lead to a one-sided or lack of reference to evidence. This would make it difficult or even impossible to adequately realize evidence-informed practice
...
- three possible explanations could be due to the operationalization of the dependent or independent variable (source)
  1) often trust is assessed as a multidimensional construct: expertise, integrity and benevolence vs. overall assessment we have used in our study. But in studies with the multidimensional construct, lower trust in scientists, especially in terms of integretiy and benevolence, but globally still rather high

  2) we have analyzed trust in specific statements to increase internal validity  but previous studies have analyzed trust in sources without using a content statement, i.e. only asking how much they trust statements from, for example, scientists
  ...
  3) publication body might have confounded the results as we described journal vs. teacher blog
...
- In this regard, I finally want to highlight that we have only analyzed trust as a key predictor for the engagement with evidence
  ...
  - but that would be an important aspect for future studies to look at
