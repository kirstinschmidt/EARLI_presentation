...
<!-- dann passt der Titel in eine Zeile--> 
...
<!-- Hab hier ein bisschen abgeschwächt, denn es mag ja das eine oder andere Paradoxon geben --> 
...
![`r shiny::HTML("<center>(cf. Schmidt et al., 2022)</center>")`](images/epitomes.png){fig-align="center" width=60%} 
...
![](images/table_results.png){width=100%}
