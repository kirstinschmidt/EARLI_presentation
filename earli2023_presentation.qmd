...
- we all know that teachers can draw on different information sources when it comes to professional actions e.g., anecdotal evidence such as advises from colleagues or scientific evidence - findings from a research study
...
::: notes
- hence question arises what barriers prevent teachers from doing so
- lots of research on this question. I am just naming a few of the identified barriers to get an impression
  - resources 
  - belief systems 
...
- teachers often choose this second-hand evaluation, hence trust can be a central predictor/indicator for the extent to which teachers actually consider scientific evidence in their school practice
...
- this evaluation of trustworthiness can be influenced by different subjective criteria - such as teachers' belief systems
:::
...
- beliefs sources of evidence itself can influence the trustworthiness
- findings from previous studies show that teachers primarily consider anecdotal evidence - own teaching experience, advice from colleagues - in their practice and also trust information from teachers more than information from scientists especially when it comes to practical advises
...
- In addition to different sources, teachers prior beliefs about specific educational topics might also influence teachers' trust ratings
...
- for this purpose, we calculated different Bayesian multilevel models
...
- I do not want to explain the results in detail, but what we can see is that our descriptive impression is also supported inferentially which we can see by looking atR2 (square) and the highest density intervalls
...
- three possible explanations why our results and previous results differ. these explanations refer to the operationalization of the dependent or independent variable (source)
  1) In the mentioned studies on teachers' trust in different sources, trust is often assessed as a multidimensional construct: expertise, integrity and benevolence. However, we have used the overall assessment of the German Science Barometer.
  ...
  3) our chosen publication outlets might have confounded the results as a study by Braten & Ferguson showed that social media is rated less trustworthy. Hence, the publication outlet 'teacher blog' may have lead to lower trust ratings of anecdotal evidence 
