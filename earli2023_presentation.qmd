...
- happy to present an experimental study in which my colleagues and I analyzed how teachers trust in scientific evidence
...
- we all know that teachers can draw on different information sources e.g., anecdotal evidence such as advises from colleagues or scientific evidence when it comes to professional actions
- Considering scientific evidence in school practice is increasingly valued by policy makers and scientists
- Scientific evidence can help to e.g., develop new practices or solve problems that have repeatedly emerge -> known as evidence-informed practice
...
::: notes
- hence question arises what arriers prevent teachers from doing so
- previous research has identified numerous barriers. I am just naming a few examples.
  - limited resources 
  - negative belief systems 
  - lack of cognitive abilities/competencies 
:::
...
- Sticking to the abilities/competencies in more detail
...
- however, the evaluation of trust can be influenced by teachers' belief systems
::: 
...
- now I am going to present beliefs that might influence second-hand evaluation in more detail
:::
...
- I will start with beliefs about the trustworthiness of different sources of evidence
- findings from previous studies exist on how teachers use and trust different information sources
- from these findings we know that teachers primarily consider anecdotal evidence - own teaching experience, advice from colleagues - in their practice and also trust information from teachers more than information from scientists especially when it comes to practical advices
...
- This (can) lead(s) to ineffective or dysfunctional practice - think, for example, of common misconceptions such as learning styles
...
- Furthermore, teachers prior beliefs about specific educational topics might also influence teachers' second-hand evaluation
...
- there are initial insights on the existence of confirmation bias in data-based decision making based on qualitative analyses
- but to the best of my knowledge only one quantitative study exists that focus on interpreting scientific evidence
- the study shows that teachers rather show a confirmation bias than a hindsight bias when evaluating scientific studies 
  - in this study confirmation bias is apparent in first-hand evaluation (e.g., evaluating the appropriateness of a study’s design)
...
- in other words confirmation bias might be problematic because
...
- for this purpose, we calculated different Bayesian multi level models
...
- I do not want to explain the results in detail, but what we can see is that our descriptive impression is also supported inferentially as R2 increases and HDI XXX
...
- three possible explanations could be due to the operationalization of the dependent or independent variable (source)
  - often trust is assessed as a multidimensional construct: expertise, integrity and benevolence vs. overall assessment we have used in our study
...
- our result on confirmation bias is consistent with previous research on first-hand evaluation 
