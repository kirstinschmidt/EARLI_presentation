...
- we all know, teachers can draw on different information sources e.g., anecdotal evidence such as advises of colleagues or scientific evidence
- the latter is increasingly valued by policy makers and scientists and known as evidence-informed practice
- the general idea is that teachers are encouraged to consider scientific findings in their professional actions to e.g., develop new practices or solve problems that have repeatedly emerge
...
::: notes
- hence, question arises: what are the barriers that prevent teachers from doing so?
...
- If we now specifically look at the abilities/competencies, teachers often struggle with interpreting and understanding scientific information as well as evaluating its veracity i.e., to evaluate the appropriateness of the study design, for example.  
...
:::{style="font-size: 0.8em"}
* [Teachers often evaluate scientific evidence secondhand: instead of evaluating its veracity, they evaluate its credibility and trustworthiness]{.imp2} <br>
...
- if we evaluate the extent to which an information, e.g., scientific evidence, appears trustworthy, we conduct what is known as secondhand evaluation
  - hence, teachers do not ask to what extent the statement is true - that would be firsthand evaluation - but to what extent they can trust the statement 
...
- the first possible influencing factor refers to beliefs about the trustworthiness of different sources of evidence
...
- another influencing factor might refer to teachers prior beliefs about specific educational topics
...
- the study shows that teachers rather show a confirmation bias than a hindsight bias when evaluating scientific studies 
  - in this study confirmation bias is apparant in firsthand evaluation (e.g., evaluating the appropriateness of a study’s design)
  - thus, we wanted to investigate whether confirmation bias is also apparant in secondhand evaluation
...
- to test our hypotheses we presented teachers with in total two out of four different claims from educational science
  ...
  - the order whether the claim was made by a teacher or a scientist was randomized and 
...
- the procedure was always the same
  - first we presented the teachers with the topic, e.g., integration of text and picture
...
- what is quite obvious when we look at both source columns is that the average trust ratings for scientific evidence are higher than for anecdotal evidence
...
- HDIS included 0 and are rather small around zero -> evidence for null-hypothesis
...
- three possible explanations could be due to the operationalization of the dependent or independent variable (source)
  - trust as a multidimensional construct: expertise, integrity and benevolence vs. overall assessment we have used in our study
    - in studies with the multidimensional construct, lower trust in scientists, especially in terms of integretiy and benevolence, but globally still rather high
  ...
  - publication body might have confounded the results as we described journal vs. teacher blog
...
- the results show that confirmation bias is also apparent in secondhand evaluations

- Thus, taking both results together, one could argue that it is not a general lack of trust in science that prevents teachers from considering scientific evidence in their school practice, rather which filters come into play to evaluate the evidence. Confirmation bias might work as such a filter and thus can be problematic for an adequate realization of evidence-informed practice.
  - if teachers trust evidence that is consistent with their beliefs more and rather distrust evidence that is contradictory, they will continue to teach as before
    - unproblematic as long as the teachers’ practice is tried and tested.
    - but problematic when it either comes to concepts that are not supported by evidence but continue to persist in practice, or when one-sided evidence is used to develop new approaches or to overcome hitherto unsolved problems as this makes it difficult to stimulate new avenues.
...
- familiarity of the source might be important aspect: trusted colleague more trustworthy than an anonymous blogposter; but in previous studys rather generic terms were used such as "experienced teacher" or "a teacher who has taught at a school for a number of years" 
- context in which the evidence is intended to be used (e.g., teachers appeared more trustworthy when it came to pracitical recommendations, Hendriks et al., 2021)
...
- challenge of designing internally valid study materials: 
  ...
  - effects of heterogeneity:
    ...
    - characteristics of scientific evidence:
      - research paradigms (experimental vs. observatrional research)
